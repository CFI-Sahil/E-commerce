...
import { productsData } from "../Category_Section/productData";
import type { ProductItem } from "../Category_Section/productData";
...
const Category_Page: React.FC = () => {
  ...
  const filteredProducts: ProductItem[] = productsData.filter(
    ...
    <>
      ...
      <div className=" px-5 md:px-10 lg:px-20 font-primary">
        ...
        <div className="flex items-center capitalize py-5 list-none">
          <li className="text-[12px] text-gray-400">Home</li>
        ...
        {filteredProducts.length === 0 ? (
          <div className="flex justify-center items-center h-[70vh]">
            <img
              src={noProdFound}
              alt=""
              className="w-64 md:h-auto md:w-auto"
            />
          </div>
        ) : (
